...
def test_raises_get_mask_card_number(
    invalid_data_int, invalid_data_list, invalid_data_empty_string, invalid_data_few_digits, many_digits
):
...
def test_raises_get_mask_account(
    invalid_data_int, invalid_data_list, invalid_data_empty_string, few_digits_for_account_number, many_digits
):
    with pytest.raises(ValueError):
        get_mask_card_number(invalid_data_int)
    with pytest.raises(ValueError):
